...
class spell_warr_sweeping_strikes : public AuraScript
{
    ...
    void HandleProc(AuraEffect const* aurEff, ProcEventInfo& eventInfo)
    {
        ...
        // Prevent Whirlwind from re-triggering this proc on every additional target it hits
        if (spellInfo && spellInfo->Id == SPELL_WARRIOR_WHIRLWIND_MAIN)
            caster->AddSpellCooldown(SPELL_WARRIOR_SWEEPING_STRIKES_EXTRA_ATTACK_1, 0, 500);
